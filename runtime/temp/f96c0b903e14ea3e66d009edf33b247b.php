<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/guo.yaoget.cn/public/../application/index/view/member/index.html";i:1572856931;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<section class="aui-flexView">
    ...
    <section class="aui-scrollView">
        <div class="aui-flex-box">
            ...
            <div class="aui-flex-box-bd"><?php echo $info['nickname']; ?>
            </div>
...
<!--                    <i class="icon icon-eye"></i>-->
                ...
                <h3><?php echo $info['money']; ?></h3>
                <!--                        <p>-->
                <!--                            最近收益 <em>6.02</em>-->
                <!--                        </p>-->
            </div>
            <div style="text-align: right;line-height: 2">
                <button style="width: 50px;height: 25px;background: #FF3030;border: 1px solid #FF3030;color: white;line-height: 25px;" class="tbox">
...
<!--                <p style="    color: #808080;">充值300送150</p>-->
        ...
        <div class="aui-icon-box">
            ...
            <a class="aui-flex-box" href="/index/member/order">
                ...
                <div class="aui-flex-box-bd">我的订单
                </div>
                <div class="aui-flex-box-fr"></div>
            </a>
                            ...
                            function(res){
                                if (res.err_msg == "get_brand_wcpay_request:ok") { // 支付成功
                                    $.ajax({
                                        ...
                                        data:{price:price},
                                        dataType:'json',
                                        url:'http://guo.yaoget.cn/index/member/chongzhi',
                                        success: function (res) {
                                            console.log(res)
                                            if(res.code == 400){
                                                alert(res.msg);
