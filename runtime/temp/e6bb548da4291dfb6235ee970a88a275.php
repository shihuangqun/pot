<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/www/wwwroot/wx.glcgpt.com/public/../application/admin/view/task/add.html";i:1572506491;s:69:"/www/wwwroot/wx.glcgpt.com/application/admin/view/layout/default.html";i:1570347773;s:66:"/www/wwwroot/wx.glcgpt.com/application/admin/view/common/meta.html";i:1570347773;s:68:"/www/wwwroot/wx.glcgpt.com/application/admin/view/common/script.html";i:1570347773;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="category/index" data-params='{"custom[type]":"task"}' class="form-control selectpage" name="row[category_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-buy_num" data-rule="required" class="form-control" name="row[buy_num]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-task_num" data-rule="required" class="form-control" name="row[task_num]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-read" data-rule="required" class="form-control" name="row[read]" type="number" value="0">
        </div>
    </div>
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Already_num'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-already_num" class="form-control" name="row[already_num]" type="number">-->
<!--        </div>-->
<!--    </div>-->
